  ...
  return (
    <div className={`table-indicator-table-item-1 ${className || ""}`}>
      <div className="summary">
        <div className="name-6 roboto-normal-astronaut-14px">
          <span className="span-4 roboto-normal-astronaut-14px">{spanText1}</span>
        </div>
        <div className="amount-4 roboto-normal-blue-bell-14px">
          <span className="span-4 roboto-normal-blue-bell-14px">{spanText2}</span>
        </div>
        <div className="summary-1 roboto-normal-astronaut-14px">
          <span className="span-4 roboto-normal-astronaut-14px">{spanText3}</span>
        </div>
      </div>
