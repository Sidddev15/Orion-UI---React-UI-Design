      ...
      <div className="graph">
        ...
        <div className="info">
          <div className="title-4">
            <div className="name-2 roboto-normal-astronaut-20px">
          ...
          <div className="overlap-group2">
            <div className="value-1">
              ...
              <div className="indicator">
                ...
                <div className="percent valign-text-middle roboto-normal-jade-14px">
                  <span>
      ...
      <div className="table">
        ...
        <div className="row roboto-normal-astronaut-14px">
          ...
          <div className="overlap-group-2">
            ...
            <img className="chart" src="/img/chart-17@2x.png" alt="Chart" />
          </div>
        </div>
      </div>
    </div>
